...
Item {
    ...
    readonly property int  canvasRes: 200
...
grabToImage(function(result) {
                                 ...
                                 }, Qt.size(root.canvasRes, root.canvasRes))
                            }
                        }
                        ...
                        Canvas {
                            ...
                            onPaint: {
                                ...
                                var ctx = getContext("2d")
                                var CR = root.canvasRes
                                ctx.clearRect(0, 0, CR, CR)
                                ctx.drawImage(grabResult.url, 0, 0, CR, CR)
                                var raw = ctx.getImageData(0, 0, CR, CR).data
...
onPaint: {
                        ...
                        MouseArea {
                            ...
                            onPositionChanged: {
                                var GRID = 32, CELL = root.canvasRes/GRID, BRUSH_R = 2
                                ...
                                for (var dr = -BRUSH_R; dr <= BRUSH_R; dr++) {
                                    for (var dc = -BRUSH_R; dc <= BRUSH_R; dc++) {
                                        ...
                                        if (src) {
var sx  = Math.min(Math.floor(nc*CELL + CELL/2), root.canvasRes-1)
                                             var sy  = Math.min(Math.floor(nr*CELL + CELL/2), root.canvasRes-1)
                                             var idx = (sy*root.canvasRes + sx)*4
...
model: 33
                    ...
                    Item {
                        ...
                        Column {
                            anchors { fill: parent; topMargin: 14; leftMargin: 18; rightMargin: 18 }
                            spacing: 0
                ...
                Column {
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            font.family: "Ndot 57"; font.pixelSize: 14; font.letterSpacing: 1
                            color: Qt.rgba(200/255,184/255,154/255,0.2)
                        }
                        Text {
                    ...
                    Row {
                        ...
                        Row {
                            ...
                            Text {
                                ...
                                font.family: "Ndot 57"; font.pixelSize: 12; font.letterSpacing: 1
