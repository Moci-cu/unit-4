...
ShellRoot {
    ...
    Variants {
        ...
        PanelWindow {
            ...
            // Fade + fermeture — match 0.8s hide video
            Timer {
                id: hideFadeTimer
                interval: 500   // 0.5s après le début de hide → fade sur les 300ms restantes
                repeat: false
            ...
            Item {
                ...
                Item {
                    ...
                    Column { spacing:2
                        Row { spacing:5
                            ...
                            Text{text:"SESSION LOCKED";font.family: "Ndot 57";font.pixelSize:9;font.letterSpacing:2;color:"#463f2e"}
                        }
                        Text{text:"NODE · "+root.currentUser+"@arch";font.family: "Ndot 57";font.pixelSize:9;font.letterSpacing:2;color:"#463f2e"}
                        Text{text:"セッションロック中";font.family: "Ndot77JPExtended";font.pixelSize:8;color:"#463f2e";opacity:0.7}
                    }
                }
                Item {
                    ...
                    z:5; opacity:parent.uiOp
                    Column { spacing:2
                        Text{text:root.clockFull;font.family: "Ndot 57";font.pixelSize:9;font.letterSpacing:2;color:"#463f2e";width:200;horizontalAlignment:Text.AlignRight}
                        Text{text:"LONGVIC · FR";font.family: "Ndot 57";font.pixelSize:9;font.letterSpacing:2;color:"#463f2e";width:200;horizontalAlignment:Text.AlignRight}
                    }
                }
                Item {
                    ...
                    z:5; opacity:parent.uiOp
                    Column { spacing:2
                        Text{text:"KERNEL 6.13.2";font.family: "Ndot 57";font.pixelSize:9;font.letterSpacing:2;color:"#463f2e"}
                        Text{text:"WM · hyprland";font.family: "Ndot 57";font.pixelSize:9;font.letterSpacing:2;color:"#463f2e"}
                    }
                }
                Item {
                    ...
                    z:5; opacity:parent.uiOp
                    Column { spacing:2
                        Text{text:"ARCH LINUX · RX 6700 XT";font.family: "Ndot 57";font.pixelSize:9;font.letterSpacing:2;color:"#463f2e";width:220;horizontalAlignment:Text.AlignRight}
                    }
                }
                ...
                Item {
                    ...
                    Text {
                        ...
                        font.family: "Ndot 57";font.pixelSize:8;font.letterSpacing:3;color:"#463f2e";y:2
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        // Grille fine
                        Repeater { model:20; delegate: Rectangle { required property int index; x:index*20; y:0; width:1; height:panelRect.height; color:Qt.rgba(70/255,63/255,46/255,0.06) } }
                        Repeater { model:Math.ceil(panelRect.height/20); delegate: Rectangle { required property int index; x:0; y:index*20; width:panelRect.width; height:1; color:Qt.rgba(70/255,63/255,46/255,0.06) } }
                        ...
                        Column {
                            ...
                            Item { width:parent.width;height:90
                                Rectangle{width:76;height:76;border.color:"#463f2e";border.width:1;color:"transparent"
                                    ...
                                    Text{text:"NR";font.family: "Ndot 57";font.pixelSize:7;color:"#7a7358";opacity:0.5;anchors.top:parent.top;anchors.left:parent.left;anchors.margins:3}
                                    Text{text:"2B";font.family: "Ndot 57";font.pixelSize:7;color:"#7a7358";opacity:0.5;anchors.bottom:parent.bottom;anchors.right:parent.right;anchors.margins:3}
                                }
                            }
                            Text{text:root.currentUser.toUpperCase();font.family: "Ndot 57";font.pixelSize:13;font.letterSpacing:3;color:"#463f2e";anchors.horizontalCenter:parent.horizontalCenter}
                            Item{width:1;height:4}
                            Text{text:"ユニット · アクティブ";font.family: "Ndot77JPExtended";font.pixelSize:8;color:"#7a7358";anchors.horizontalCenter:parent.horizontalCenter}
                            Item{width:1;height:20}
                            Text{text:root.clockStr;font.family: "Ndot 57";font.pixelSize:46;font.letterSpacing:2;color:"#463f2e";anchors.horizontalCenter:parent.horizontalCenter}
                            Item{width:1;height:6}
                            Text{text:root.dateStr;font.family: "Ndot 57";font.pixelSize:9;font.letterSpacing:3;color:"#7a7358";anchors.horizontalCenter:parent.horizontalCenter}
                            Item{width:1;height:20}
                            ...
                            Item { width:parent.width;height:40
                                ...
                                FocusScope {
                                    ...
                                    TextInput {
                                        ...
                                        font.family: "Ndot 57";font.pixelSize:12;font.letterSpacing:2
                                        ...
                                        Text{visible:parent.text==="";anchors.verticalCenter:parent.verticalCenter
                                            text:"mot de passe...";font.family: "Ndot 57";font.pixelSize:11;font.italic:true;color:"#7a7358";opacity:0.5}
                                    }
                                }
                            }
                            ...
                            Row{anchors.horizontalCenter:parent.horizontalCenter;spacing:6
                                Repeater{model:6;delegate:Rectangle{required property int index;width:6;height:6;color:"transparent";border.color:"#7a7358";border.width:1
                                    Rectangle{visible:index<root.lockInput.length;anchors.fill:parent;color:"#463f2e"}}}}
                            Item{width:1;height:6}

                            // Erreur
                            Text{text:"AUTHENTIFICATION ÉCHOUÉE";font.family: "Ndot 57";font.pixelSize:8;font.letterSpacing:2;color:"#6e2a2a"
                                anchors.horizontalCenter:parent.horizontalCenter
                            ...
                            Item{width:parent.width;height:42
                                ...
                                Text{anchors.centerIn:parent;text:"DÉVERROUILLER";font.family: "Ndot 57";font.pixelSize:10;font.letterSpacing:3
                ...
                Timer{id:focusRetry;interval:80;repeat:true;property int cnt:0
                    onTriggered:{pwInput.forceActiveFocus()
                        if(++cnt>=15){running=false;cnt=0}}}
