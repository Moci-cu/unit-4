...
Item {
    ...
    Column {
        ...
        Rectangle {
            ...
            Column {
                ...
                Text {
                    ...
                    font.family: "Ndot 57"; font.pixelSize: 8; font.letterSpacing: 3
                ...
                Text {
                    ...
                    font.family: "Ndot 57"; font.pixelSize: 9
        ...
        Text {
            ...
            text:  root.companions[root.currentIdx].name
            font.family: "Ndot 57"; font.pixelSize: 8; font.letterSpacing: 2
            color: root.companions[root.currentIdx].color
